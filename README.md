...
```
curl -fsSL https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect \
  | NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /var/log/nixos-infect.log
```
...
runcmd:
  - curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | PROVIDER=digitalocean NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /tmp/infect.log
```
...
runcmd:
  - curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | PROVIDER=digitalocean NIXOS_IMPORT=./host.nix NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /tmp/infect.log
```
...
curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | NIX_CHANNEL=nixos-25.11 bash
```
...
runcmd:
  - curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | PROVIDER=hetznercloud NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /tmp/infect.log
```
...
curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /tmp/infect.log
```
...
Requires the same static network settings that Digital Ocean does.
    ...
    curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | PROVIDER=servarica NIX_CHANNEL=nixos-25.11 bash
...
runcmd:
  - curl https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect |  NIXOS_IMPORT=./host.nix NIX_CHANNEL=nixos-25.11 bash 2>&1 | tee /tmp/infect.log
```
...
```command
# wget -O- https://raw.githubusercontent.com/g1ibby/nixos-infect/master/nixos-infect | NIX_CHANNEL=nixos-25.11 bash -x
```
